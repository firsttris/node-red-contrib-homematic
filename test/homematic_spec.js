...
describe('HomematicNode', function() {
    ...
    describe('#homematic' , function() {
        ...
        it('should create & send Session.login object', function(done) {
            var flow = [{"id":"homematicNode1","type":"homematic","name":"homematicNode","_topic":"_Session.login","_method":"Session.login","_username":"rudi","_password":"ratlos","wires":[["helperNode1"]]},
        ...
        it('should create & send Interface.setValue object', function(done) {
            var flow = [{"id":"homematicNode1","type":"homematic","name":"homematicNode","_topic":"_Interface.setValue","_method":"Interface.setValue","_interface":"BidCos-RF","_address":"customAddress","_customAddress":"123456789","_valueKey":"ACTUAL_TEMPERATURE","_type":"string","_value":"22","wires":[["helperNode1"]]},
                        {id:"helperNode1", type:"helper", wires:[]}];
            helper.load(homematicNode, flow, function() {
                var homematicNode1 = helper.getNode("homematicNode1");
                var helperNode1 = helper.getNode("helperNode1");
        ...
        it('should create & send Interface.init object', function(done) {
            var flow = [{"id":"homematicNode1","type":"homematic","name":"homematicNode","_topic":"_Interface.init","_method":"Interface.init","_interface":"BidCos-RF","_url":"endpointIp","_interfaceId":"1234","wires":[["helperNode1"]]},
                        {id:"helperNode1", type:"helper", wires:[]}];
            helper.load(homematicNode, flow, function() {
                var homematicNode1 = helper.getNode("homematicNode1");
                var helperNode1 = helper.getNode("helperNode1");
